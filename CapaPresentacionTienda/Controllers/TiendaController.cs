...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult AgregarCarrito(int idproducto)
        {
            ...
            {
                // Manejo de la referencia nula (puede ser un error o una redirección)
                return Json(new { respuesta = false, mensaje = "Sesión no válida" }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult ListarProductosCarrito()
        {
            ...
            {
                // Manejo de la referencia nula (puede ser un error o una redirección)
                return Json(new { data = new List<CARRITO>() }, JsonRequestBehavior.AllowGet);
            }
        ...
        [HttpPost]
        public JsonResult ObtenerDistrito(string IdDepartamento, string IdLocalidad)
        {
            List<DISTRITO> oLista = new List<DISTRITO>();

            oLista = new CN_Ubicacion().ObtenerDistrito(IdDepartamento, IdLocalidad);
        ...
        public async Task<JsonResult> ProcesarPago(List<CARRITO> oListaCarrito, VENTA oVenta)
        {
            ...
            PurchaseUnit purchaseUnit = new PurchaseUnit()
            {
                ...
                description = "Compra de articulo de MUSIC STORE",
                items = oListaItem
            };
            ...
            Checkout_Order oCheckOutOrder = new Checkout_Order()
            {
                ...
                {
                    brand_name = "MusicStore.com",
                    landing_page = "NO_PREFERENCE",
                    user_action = "PAY_NOW",
                    return_url = "https://localhost:44339/Tienda/PagoEfectuado",
                    cancel_url = "https://localhost:44339/Tienda/Carrito"
                }
            };
